...
public class ConsumerQueueGateway implements QueueGateway {
    ...
    public ConsumerQueueGateway(final CancelEventTicketsUseCase cancelEventTicketsUseCase, final CreateTicketForCustomerUseCase createTicketForCustomerUseCase, final ObjectMapper mapper) {
